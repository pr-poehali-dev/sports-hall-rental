        ...
        <div className="container mx-auto px-4">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-secondary">SportArena</span>
            </div>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">info@sportarena.ru</p>
                      <p className="text-muted-foreground">booking@sportarena.ru</p>
                    </div>
                  </div>
      ...
      <footer className="bg-secondary text-secondary-foreground py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold">SportArena</span>
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-secondary-foreground/80">
            <p>© 2024 SportArena. Все права защищены.</p>
